...
-- del panel. Contiene las 16 migraciones en orden mas el seed.
--
...
from (values
  ('cano', 'tuberia', 'Caño / tubo de proceso', true, true, 1),
  ('acc_soldar_ind', 'tuberia', 'Accesorio para soldar (codo/tee/reducción)', true, true, 2),
  ('brida', 'tuberia', 'Brida', false, true, 3),
  ('niple', 'tuberia', 'Niple / medio niple', false, true, 4),
  ('acc_rosc_sw', 'tuberia', 'Accesorio roscado / socket weld', false, true, 5),
  ('valvula_ind', 'tuberia', 'Válvula industrial', false, true, 6),
  ('union_sanitaria', 'sanitario', 'Unión sanitaria (Clamp/SMS/DIN)', false, true, 7),
  ('acc_soldar_san', 'sanitario', 'Accesorio sanitario para soldar (incl. pharma)', true, true, 8),
  ('valvula_san', 'sanitario', 'Válvula sanitaria (mariposa/pistón)', false, true, 9),
  ('bomba', 'sanitario', 'Bomba sanitaria / centrífuga', false, false, 10),
  ('instrumentacion', 'sanitario', 'Instrumentación / alta presión', false, true, 11),
  ('acc_tanque', 'sanitario', 'Accesorio para tanque', false, true, 12),
  ('chapa', 'materiaprima', 'Chapa / bobina', true, false, 13),
  ('barra', 'materiaprima', 'Barra redonda', true, false, 14),
  ('planchuela', 'materiaprima', 'Planchuela', true, false, 15),
  ('angulo', 'materiaprima', 'Ángulo', true, false, 16),
  ('tapa_puerta', 'tapas', 'Tapa / puerta de tanque', false, false, 17),
  ('bulon', 'bulones', 'Tornillo / bulón', false, false, 18),
  ('varilla_roscada', 'bulones', 'Varilla roscada / espárrago', false, false, 19),
  ('baranda', 'arquitectura', 'Baranda / pasamanos', false, false, 20),
  ('griferia', 'arquitectura', 'Grifería / herrajes de baño', false, false, 21),
  ('tungsteno', 'soldadura', 'Electrodo de tungsteno', false, false, 22),
  ('varilla_tig', 'soldadura', 'Varilla TIG', false, false, 23),
  ('alambre_mig', 'soldadura', 'Alambre MIG', false, false, 24),
  ('electrodo_revestido', 'soldadura', 'Electrodo revestido (MMA)', false, false, 25),
  ('disco_corte', 'abrasivos', 'Disco de corte / abrasivo', false, false, 26),
  ('decapante', 'quimica', 'Decapante / pasivante', false, false, 27)
...
--
-- criterio sale de data/criterios.json: 22 pares se filtran por medida,
-- 20 por el aporte del grado, el resto no se filtra.
...
from (values
  ('cano', 'Accesorios para soldar', 'acc_soldar_ind', 1, 'medida'),
  ('cano', 'Consumible de aporte', 'varilla_tig', 1, 'aporte'),
  ('cano', 'Consumible de aporte', 'alambre_mig', 2, 'aporte'),
  ('cano', 'Consumible de aporte', 'electrodo_revestido', 3, 'aporte'),
  ('cano', 'Bridas', 'brida', 1, 'medida'),
  ('cano', 'Química de terminación', 'decapante', 1, 'ninguno'),
  ('cano', 'Química de terminación', 'pasivante', 2, 'ninguno'),
  ('cano', 'Química de terminación', 'neutralizante', 3, 'ninguno'),
  ('cano', 'Abrasivos', 'disco_corte', 1, 'ninguno'),
  ('cano', 'Abrasivos', 'flap', 2, 'ninguno'),
  ('cano', 'Abrasivos', 'lija', 3, 'ninguno'),
  ('acc_soldar_ind', 'Caño / tubo', 'cano', 1, 'medida'),
  ('acc_soldar_ind', 'Caño / tubo', 'tubo', 2, 'medida'),
  ('acc_soldar_ind', 'Consumible de aporte', 'varilla_tig', 1, 'aporte'),
  ('acc_soldar_ind', 'Consumible de aporte', 'alambre_mig', 2, 'aporte'),
  ('acc_soldar_ind', 'Consumible de aporte', 'electrodo_revestido', 3, 'aporte'),
  ('acc_soldar_ind', 'Bridas', 'brida', 1, 'medida'),
  ('acc_soldar_ind', 'Química de terminación', 'decapante', 1, 'ninguno'),
  ('acc_soldar_ind', 'Química de terminación', 'pasivante', 2, 'ninguno'),
  ('acc_soldar_ind', 'Química de terminación', 'neutralizante', 3, 'ninguno'),
  ('acc_soldar_ind', 'Abrasivos', 'disco_corte', 1, 'ninguno'),
  ('acc_soldar_ind', 'Abrasivos', 'flap', 2, 'ninguno'),
  ('acc_soldar_ind', 'Abrasivos', 'lija', 3, 'ninguno'),
  ('brida', 'Juntas / gaskets', 'junta', 1, 'ninguno'),
  ('brida', 'Espárragos, tuercas y arandelas', 'varilla_roscada', 1, 'ninguno'),
  ('brida', 'Espárragos, tuercas y arandelas', 'tuerca', 2, 'ninguno'),
  ('brida', 'Espárragos, tuercas y arandelas', 'arandela', 3, 'ninguno'),
  ('brida', 'Consumible de aporte', 'varilla_tig', 1, 'aporte'),
  ('brida', 'Consumible de aporte', 'alambre_mig', 2, 'aporte'),
  ('brida', 'Consumible de aporte', 'electrodo_revestido', 3, 'aporte'),
  ('brida', 'Caño', 'cano', 1, 'medida'),
  ('niple', 'Accesorios roscados / SW', 'acc_rosc_sw', 1, 'medida'),
  ('niple', 'Sellador / antigripante de rosca', 'sellador_rosca', 1, 'ninguno'),
  ('niple', 'Sellador / antigripante de rosca', 'lubricante', 2, 'ninguno'),
  ('niple', 'Válvulas', 'valvula_ind', 1, 'medida'),
  ('acc_rosc_sw', 'Niples', 'niple', 1, 'medida'),
  ('acc_rosc_sw', 'Sellador / antigripante de rosca', 'sellador_rosca', 1, 'ninguno'),
  ('acc_rosc_sw', 'Sellador / antigripante de rosca', 'lubricante', 2, 'ninguno'),
  ('acc_rosc_sw', 'Válvulas', 'valvula_ind', 1, 'medida'),
  ('acc_rosc_sw', 'Consumible (versiones SW)', 'electrodo_revestido', 1, 'ninguno'),
  ('acc_rosc_sw', 'Consumible (versiones SW)', 'varilla_tig', 2, 'ninguno'),
  ('valvula_ind', 'Bridas', 'brida', 1, 'medida'),
  ('valvula_ind', 'Juntas', 'junta', 1, 'ninguno'),
  ('valvula_ind', 'Espárragos y tuercas', 'varilla_roscada', 1, 'ninguno'),
  ('valvula_ind', 'Espárragos y tuercas', 'tuerca', 2, 'ninguno'),
  ('valvula_ind', 'Espárragos y tuercas', 'arandela', 3, 'ninguno'),
  ('valvula_ind', 'Accesorios roscados / niples', 'acc_rosc_sw', 1, 'medida'),
  ('valvula_ind', 'Accesorios roscados / niples', 'niple', 2, 'medida'),
  ('union_sanitaria', 'Juntas sanitarias', 'junta', 1, 'ninguno'),
  ('union_sanitaria', 'Abrazaderas clamp', 'abrazadera', 1, 'ninguno'),
  ('union_sanitaria', 'Accesorios sanitarios para soldar', 'acc_soldar_san', 1, 'medida'),
  ('union_sanitaria', 'Tubo sanitario', 'tubo', 1, 'medida'),
  ('acc_soldar_san', 'Consumible de aporte 316L', 'varilla_tig', 1, 'aporte'),
  ('acc_soldar_san', 'Consumible de aporte 316L', 'alambre_mig', 2, 'aporte'),
  ('acc_soldar_san', 'Respaldo / back-purge', 'respaldo', 1, 'ninguno'),
  ('acc_soldar_san', 'Química: decapar/pasivar + revestimiento', 'decapante', 1, 'ninguno'),
  ('acc_soldar_san', 'Química: decapar/pasivar + revestimiento', 'pasivante', 2, 'ninguno'),
  ('acc_soldar_san', 'Química: decapar/pasivar + revestimiento', 'revestimiento', 3, 'ninguno'),
  ('acc_soldar_san', 'Uniones sanitarias', 'union_sanitaria', 1, 'medida'),
  ('valvula_san', 'Juntas y kit de repuesto', 'junta', 1, 'ninguno'),
  ('valvula_san', 'Juntas y kit de repuesto', 'acc_valvula_san', 2, 'ninguno'),
  ('valvula_san', 'Actuadores', 'actuador', 1, 'ninguno'),
  ('valvula_san', 'Uniones sanitarias', 'union_sanitaria', 1, 'medida'),
  ('valvula_san', 'Instrumentación', 'instrumentacion', 1, 'medida'),
  ('bomba', 'Repuestos de bomba', 'acc_bomba', 1, 'ninguno'),
  ('bomba', 'Uniones sanitarias', 'union_sanitaria', 1, 'ninguno'),
  ('bomba', 'Válvulas', 'valvula_san', 1, 'ninguno'),
  ('bomba', 'Instrumentación', 'instrumentacion', 1, 'ninguno'),
  ('instrumentacion', 'Conectores y adaptadores', 'instrumentacion', 1, 'medida'),
  ('instrumentacion', 'Válvulas y manifolds', 'valvula_ind', 1, 'medida'),
  ('instrumentacion', 'Juntas', 'junta', 1, 'ninguno'),
  ('acc_tanque', 'Juntas', 'junta', 1, 'ninguno'),
  ('acc_tanque', 'Tapas y puertas', 'tapa_puerta', 1, 'ninguno'),
  ('acc_tanque', 'Sistema de limpieza (spray ball)', 'sistema_limpieza', 1, 'ninguno'),
  ('acc_tanque', 'Mirillas y soportes', 'mirilla', 1, 'medida'),
  ('acc_tanque', 'Mirillas y soportes', 'soporte_san', 2, 'medida'),
  ('chapa', 'Abrasivos: corte y acabado', 'disco_corte', 1, 'ninguno'),
  ('chapa', 'Abrasivos: corte y acabado', 'flap', 2, 'ninguno'),
  ('chapa', 'Abrasivos: corte y acabado', 'lija', 3, 'ninguno'),
  ('chapa', 'Abrasivos: corte y acabado', 'acabado', 4, 'ninguno'),
  ('chapa', 'Química de terminación', 'decapante', 1, 'ninguno'),
  ('chapa', 'Química de terminación', 'pasivante', 2, 'ninguno'),
  ('chapa', 'Química de terminación', 'limpieza', 3, 'ninguno'),
  ('chapa', 'Consumible de aporte', 'varilla_tig', 1, 'aporte'),
  ('chapa', 'Consumible de aporte', 'alambre_mig', 2, 'aporte'),
  ('chapa', 'Consumible de aporte', 'electrodo_revestido', 3, 'aporte'),
  ('chapa', 'Película / revestimiento protector', 'revestimiento', 1, 'ninguno'),
  ('chapa', 'Brocas', 'broca', 1, 'ninguno'),
  ('barra', 'Brocas', 'broca', 1, 'ninguno'),
  ('barra', 'Abrasivos', 'flap', 1, 'ninguno'),
  ('barra', 'Abrasivos', 'lija', 2, 'ninguno'),
  ('barra', 'Abrasivos', 'pulido', 3, 'ninguno'),
  ('barra', 'Consumible de aporte', 'varilla_tig', 1, 'aporte'),
  ('barra', 'Consumible de aporte', 'electrodo_revestido', 2, 'aporte'),
  ('planchuela', 'Abrasivos', 'flap', 1, 'ninguno'),
  ('planchuela', 'Abrasivos', 'lija', 2, 'ninguno'),
  ('planchuela', 'Abrasivos', 'disco_corte', 3, 'ninguno'),
  ('planchuela', 'Consumible de aporte', 'varilla_tig', 1, 'aporte'),
  ('planchuela', 'Consumible de aporte', 'electrodo_revestido', 2, 'aporte'),
  ('planchuela', 'Brocas', 'broca', 1, 'ninguno'),
  ('angulo', 'Abrasivos', 'flap', 1, 'ninguno'),
  ('angulo', 'Abrasivos', 'disco_corte', 2, 'ninguno'),
  ('angulo', 'Consumible de aporte', 'varilla_tig', 1, 'aporte'),
  ('angulo', 'Consumible de aporte', 'electrodo_revestido', 2, 'aporte'),
  ('tapa_puerta', 'Juntas de tapa', 'junta', 1, 'ninguno'),
  ('tapa_puerta', 'Herrajes (bisagras, manijas, cierres)', 'acc_tapa', 1, 'ninguno'),
  ('tapa_puerta', 'Bulonería', 'bulon', 1, 'ninguno'),
  ('tapa_puerta', 'Bulonería', 'tuerca', 2, 'ninguno'),
  ('tapa_puerta', 'Accesorios de tanque', 'acc_tanque', 1, 'ninguno'),
  ('bulon', 'Tuercas', 'tuerca', 1, 'ninguno'),
  ('bulon', 'Arandelas', 'arandela', 1, 'ninguno'),
  ('bulon', 'Antigripante / pasta lubricante', 'sellador_rosca', 1, 'ninguno'),
  ('bulon', 'Antigripante / pasta lubricante', 'lubricante', 2, 'ninguno'),
  ('bulon', 'Fijador de rosca', 'sellador_rosca', 1, 'ninguno'),
  ('varilla_roscada', 'Tuercas', 'tuerca', 1, 'ninguno'),
  ('varilla_roscada', 'Arandelas', 'arandela', 1, 'ninguno'),
  ('varilla_roscada', 'Antigripante', 'sellador_rosca', 1, 'ninguno'),
  ('varilla_roscada', 'Antigripante', 'lubricante', 2, 'ninguno'),
  ('baranda', 'Herrajes y conectores', 'herraje_arq', 1, 'ninguno'),
  ('baranda', 'Herrajes y conectores', 'arq_otro', 2, 'ninguno'),
  ('baranda', 'Accesorios para vidrio', 'acc_vidrio', 1, 'ninguno'),
  ('baranda', 'Adhesivo / sellador de montaje', 'adhesivo_montaje', 1, 'ninguno'),
  ('baranda', 'Abrasivos de acabado', 'flap', 1, 'ninguno'),
  ('baranda', 'Abrasivos de acabado', 'acabado', 2, 'ninguno'),
  ('baranda', 'Abrasivos de acabado', 'pulido', 3, 'ninguno'),
  ('baranda', 'Limpiador / pulidor', 'limpieza', 1, 'ninguno'),
  ('griferia', 'Accesorios y repuestos', 'acc_bano', 1, 'ninguno'),
  ('griferia', 'Accesorios y repuestos', 'herraje_arq', 2, 'ninguno'),
  ('griferia', 'Selladores / fijadores', 'adhesivo_montaje', 1, 'ninguno'),
  ('griferia', 'Selladores / fijadores', 'sellador_rosca', 2, 'ninguno'),
  ('griferia', 'Limpiador', 'limpieza', 1, 'ninguno'),
  ('tungsteno', 'Varilla TIG de aporte', 'varilla_tig', 1, 'ninguno'),
  ('tungsteno', 'Respaldo de raíz', 'respaldo', 1, 'ninguno'),
  ('tungsteno', 'Química de terminación', 'decapante', 1, 'ninguno'),
  ('tungsteno', 'Química de terminación', 'pasivante', 2, 'ninguno'),
  ('tungsteno', 'Química de terminación', 'neutralizante', 3, 'ninguno'),
  ('tungsteno', 'Acabado', 'flap', 1, 'ninguno'),
  ('tungsteno', 'Acabado', 'acabado', 2, 'ninguno'),
  ('tungsteno', 'Acabado', 'lija', 3, 'ninguno'),
  ('varilla_tig', 'Electrodo de tungsteno', 'tungsteno', 1, 'ninguno'),
  ('varilla_tig', 'Respaldo de raíz', 'respaldo', 1, 'ninguno'),
  ('varilla_tig', 'Química de terminación', 'decapante', 1, 'ninguno'),
  ('varilla_tig', 'Química de terminación', 'pasivante', 2, 'ninguno'),
  ('varilla_tig', 'Química de terminación', 'neutralizante', 3, 'ninguno'),
  ('varilla_tig', 'Abrasivos', 'flap', 1, 'ninguno'),
  ('varilla_tig', 'Abrasivos', 'acabado', 2, 'ninguno'),
  ('alambre_mig', 'Antiproyecciones', 'antiproyecciones', 1, 'ninguno'),
  ('alambre_mig', 'Química de terminación', 'decapante', 1, 'ninguno'),
  ('alambre_mig', 'Química de terminación', 'pasivante', 2, 'ninguno'),
  ('alambre_mig', 'Química de terminación', 'neutralizante', 3, 'ninguno'),
  ('alambre_mig', 'Abrasivos', 'disco_corte', 1, 'ninguno'),
  ('alambre_mig', 'Abrasivos', 'flap', 2, 'ninguno'),
  ('alambre_mig', 'Abrasivos', 'lija', 3, 'ninguno'),
  ('electrodo_revestido', 'Antiproyecciones', 'antiproyecciones', 1, 'ninguno'),
  ('electrodo_revestido', 'Abrasivos', 'disco_corte', 1, 'ninguno'),
  ('electrodo_revestido', 'Abrasivos', 'flap', 2, 'ninguno'),
  ('electrodo_revestido', 'Abrasivos', 'lija', 3, 'ninguno'),
  ('electrodo_revestido', 'Química de terminación', 'decapante', 1, 'ninguno'),
  ('electrodo_revestido', 'Química de terminación', 'pasivante', 2, 'ninguno'),
  ('electrodo_revestido', 'Química de terminación', 'neutralizante', 3, 'ninguno'),
  ('disco_corte', 'Acabado progresivo', 'flap', 1, 'ninguno'),
  ('disco_corte', 'Acabado progresivo', 'lija', 2, 'ninguno'),
  ('disco_corte', 'Acabado progresivo', 'acabado', 3, 'ninguno'),
  ('disco_corte', 'Cepillo de inox', 'cepillo', 1, 'ninguno'),
  ('disco_corte', 'Decapado y pasivado', 'decapante', 1, 'ninguno'),
  ('disco_corte', 'Decapado y pasivado', 'pasivante', 2, 'ninguno'),
  ('decapante', 'Secuencia: pasivar y neutralizar', 'pasivante', 1, 'ninguno'),
  ('decapante', 'Secuencia: pasivar y neutralizar', 'neutralizante', 2, 'ninguno'),
  ('decapante', 'Limpiadores y protección', 'limpieza', 1, 'ninguno'),
  ('decapante', 'Limpiadores y protección', 'revestimiento', 2, 'ninguno'),
  ('decapante', 'Verificación', 'detector', 1, 'ninguno'),
  ('decapante', 'Verificación', 'ndt', 2, 'ninguno')
